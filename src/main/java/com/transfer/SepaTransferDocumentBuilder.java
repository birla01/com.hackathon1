...
import com.directdebit.xml.schema.pain_001_003_03.AccountIdentificationSEPA;
import com.directdebit.xml.schema.pain_001_003_03.ActiveOrHistoricCurrencyAndAmountSEPA;
import com.directdebit.xml.schema.pain_001_003_03.ActiveOrHistoricCurrencyCodeEUR;
import com.directdebit.xml.schema.pain_001_003_03.AmountTypeSEPA;
import com.directdebit.xml.schema.pain_001_003_03.BranchAndFinancialInstitutionIdentificationSEPA1;
import com.directdebit.xml.schema.pain_001_003_03.BranchAndFinancialInstitutionIdentificationSEPA3;
import com.directdebit.xml.schema.pain_001_003_03.CashAccountSEPA1;
import com.directdebit.xml.schema.pain_001_003_03.CashAccountSEPA2;
import com.directdebit.xml.schema.pain_001_003_03.ChargeBearerTypeSEPACode;
import com.directdebit.xml.schema.pain_001_003_03.CreditTransferTransactionInformationSCT;
import com.directdebit.xml.schema.pain_001_003_03.CustomerCreditTransferInitiationV03;
import com.directdebit.xml.schema.pain_001_003_03.Document;
import com.directdebit.xml.schema.pain_001_003_03.FinancialInstitutionIdentificationSEPA1;
import com.directdebit.xml.schema.pain_001_003_03.FinancialInstitutionIdentificationSEPA3;
import com.directdebit.xml.schema.pain_001_003_03.GroupHeaderSCT;
import com.directdebit.xml.schema.pain_001_003_03.ObjectFactory;
import com.directdebit.xml.schema.pain_001_003_03.PartyIdentificationSEPA1;
import com.directdebit.xml.schema.pain_001_003_03.PartyIdentificationSEPA2;
import com.directdebit.xml.schema.pain_001_003_03.PaymentIdentificationSEPA;
import com.directdebit.xml.schema.pain_001_003_03.PaymentInstructionInformationSCT;
import com.directdebit.xml.schema.pain_001_003_03.PaymentMethodSCTCode;
import com.directdebit.xml.schema.pain_001_003_03.PaymentTypeInformationSCT1;
import com.directdebit.xml.schema.pain_001_003_03.RemittanceInformationSEPA1Choice;
import com.directdebit.xml.schema.pain_001_003_03.ServiceLevelSEPA;
...
class SepaTransferDocumentBuilder extends SepaXmlDocumentBuilder {
    ...
    public static String toXml(SepaTransferDocumentData source) throws DatatypeConfigurationException, IOException {
        ...
        FileUtils.writeStringToFile(new File("C:\\Users\\dell\\pain001\\"+Calendar.getInstance().getTimeInMillis()), resultWriter.toString());
